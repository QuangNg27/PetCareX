...
export const ENDPOINTS = {
  ...
  CUSTOMERS: {
    ...
    PETS: {
      ...
      MEDICAL_HISTORY: (petId) =>
        `/api/customers/pets/${petId}/medical-history`,
      VACCINATION_HISTORY: (petId) =>
        `/api/customers/pets/${petId}/vaccination-history`,
    },
  },
  ...
  SERVICES: {
    ...
    EXAMINATIONS: {
      ...
      LIST_WITH_MEDICINES: "/api/services/examinations/with-medicines",
      ...
      PRESCRIPTIONS: (examId) =>
        `/api/services/examinations/${examId}/prescriptions`,
    },
