...
class CustomerController {
  ...
  createPetForCustomer = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.createPetForCustomer(
        customerId,
        req.body
      );
      res.status(201).json(result);
  ...
  updatePet = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.updatePet(
        petId,
        customerId,
        req.body
      );
  ...
  getPetMedicalHistory = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.getPetMedicalHistory(
        petId,
        customerId,
        limit
      );
  ...
  getPetVaccinationHistory = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.getPetVaccinationHistory(
        petId,
        customerId,
        limit
      );
  ...
  UpdatePassword = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.UpdatePassword(
        customerId,
        oldPassword,
        newPassword
      );
  ...
  getAnyPetMedicalHistory = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.getAnyPetMedicalHistory(
        petId,
        limit
      );
      res.json(result);
  ...
  getAnyPetVaccinationHistory = async (req, res, next) => {
    try {
      ...
      const result = await this.customerService.getAnyPetVaccinationHistory(
        petId,
        limit
      );
      res.json(result);
