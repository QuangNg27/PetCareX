...
class ProductController {
  ...
  async getProductInventory(req, res, next) {
    try {
      ...
      const result = await this.productService.getProductInventory(
        productId,
        branchId
      );
  ...
  async getProductPriceHistory(req, res, next) {
    try {
      ...
      const result = await this.productService.getProductPriceHistory(
        productId
      );
  ...
  async getProductsByBranch(req, res, next) {
    try {
      ...
      const products = await this.productService.getProductsByBranch(branchId, {
        category,
        search,
      });
  ...
  getMedicines = async (req, res, next) => {
    try {
      const medicines = await this.productService.getMedicines();
      res.json({
        success: true,
        data: medicines,
      });
  ...
  getVaccines = async (req, res, next) => {
    try {
      const vaccines = await this.productService.getVaccines();
      res.json({
        success: true,
        data: vaccines,
      });
